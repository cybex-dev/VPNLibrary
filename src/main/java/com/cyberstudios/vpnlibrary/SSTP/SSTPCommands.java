...
public class SSTPCommands {
     ...
     * </ul>
     */
    public static final int SSTP_MSG_CALL_CONNECTED = 0x0004;
     ...
     */
    public static final int SSTP_MSG_ECHO_REQUEST = 0x0008;

    /**
     * This command is sent to a SSTP server or to a client in response to the SSTP_MSG_ECHO_REQUEST.
     */
    public static final int SSTP_MSG_ECHO_RESPONSE = 0x0009;
}
